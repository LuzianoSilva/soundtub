...
O código e o pacote 1.0.0 estão preparados, mas a publicação só deve ocorrer depois
...
- Download imutável: `https://github.com/LuzianoSilva/soundtub/releases/download/v1.0.0/SoundTub-1.0.0.nvda-addon`
...
6. Criar um repositório público no GitHub e publicar o código com a tag `v1.0.0`.
